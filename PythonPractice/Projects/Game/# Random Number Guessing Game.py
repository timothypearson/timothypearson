...
# My learnings from Tim's Tutorial
    # No.1 - Indent position for function are important to run code
...
# elif option reduces nested if statements below which was the original code. An example of improving code and making it cleaner
